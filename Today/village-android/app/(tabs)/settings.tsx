...
export default function SettingsScreen() {
  ...
  async function fetchData() {
    ...
    const [familyRes, childrenRes, eventsRes, membersRes] = await Promise.all([
      supabase
        .from('families')
        .select('id, name, plan_tier, ingestion_count, zip_code, ai_insights_enabled')
    ...
    setAiInsightsEnabled(fam?.ai_insights_enabled ?? false);
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardRow}>
              <View style={{ flex: 1 }}>
                <Text style={styles.fieldValue}>AI Insights</Text>
                <Text style={[styles.fieldLabel, { marginBottom: 0 }]}>Weather, packing tips, dress code</Text>
              </View>
              <Switch
                ...
                onValueChange={async (val) => {
                  ...
                  await supabase
                    .from('families')
                    .update({ ai_insights_enabled: val })
                    .eq('id', familyId);
                }}
